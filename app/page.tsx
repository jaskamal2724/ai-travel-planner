  ...
  const features = [
    {
      ...
      description: "Our advanced AI analyzes millions of travel data points to create your perfect itinerary in seconds."
    },
    {
      icon: <DollarSign className="h-8 w-8 text-green-500" />,
      title: "Budget Optimization",
      description: "Get maximum value from your budget with smart recommendations and cost-saving alternatives."
    },
    {
      icon: <Globe className="h-8 w-8 text-purple-500" />,
      title: "Global Coverage",
      description: "Access to 1000+ destinations worldwide with local insights and hidden gems."
    },
    {
      icon: <Clock className="h-8 w-8 text-orange-500" />,
      title: "Instant Results",
      description: "Generate comprehensive travel plans in under 30 seconds, not hours of research."
    },
    {
    ...
    },
    {
      ...
      description: "Every recommendation is tailored to your preferences, style, and travel goals."
    }
  ];
  ...
  const testimonials = [
    {
      ...
      content: "This AI planner saved me 20+ hours of research. My Tokyo trip was absolutely perfect!",
      rating: 5
    },
    {
      name: "Michael Chen",
      ...
      content: "The budget optimization feature helped me save $800 on my European business trip.",
      rating: 5
    },
    {
      ...
      content: "Planning our family vacation to Bali was stress-free and the kids loved every activity!",
      rating: 5
    }
  ];
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 py-20">
        ...
        <div className="absolute inset-0 overflow-hidden">
          ...
          <div className="absolute top-32 right-1/4 text-6xl opacity-10 animate-float">✈️</div>
          <div className="absolute top-60 left-1/3 text-5xl opacity-10 animate-float delay-1000">🗺️</div>
          <div className="absolute bottom-40 right-1/3 text-5xl opacity-10 animate-float delay-500">🏖️</div>
        </div>
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          <div className="inline-flex items-center space-x-2 bg-white/80 backdrop-blur-sm px-4 py-2 rounded-full mb-8 border border-white/20">
            ...
            <span className="text-sm font-medium text-gray-700">#1 AI Travel Planning Platform</span>
          </div>
          ...
          <p className="text-xl md:text-2xl text-gray-600 mb-8 max-w-3xl mx-auto">
            Let our AI create personalized travel itineraries that match your budget, 
            preferences, and timeline. No more hours of research – just perfect trips.
          </p>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="text-center group">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">1. Tell Us Your Preferences</h3>
              <p className="text-gray-600">Share your destination, budget, dates, and travel style</p>
            </div>
            ...
            <div className="text-center group">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">2. AI Creates Your Plan</h3>
              <p className="text-gray-600">Our AI analyzes millions of options to craft your perfect itinerary</p>
            </div>
            ...
            <div className="text-center group">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">3. Book & Enjoy</h3>
              <p className="text-gray-600">Review, customize, and book your personalized travel plan</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {testimonials.map((testimonial, index) => (
              <Card key={index} className="hover:shadow-xl transition-all duration-300 border-0 bg-gradient-to-br from-white to-gray-50/50">
                <CardContent className="p-8">
